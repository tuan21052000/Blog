...
const SignUpPage = () => {
    ...
    const handleSignUp = async (values) => {
      ...
      await updateProfile(auth.currentUser, {
        ...
        photoURL:
        "https://images.unsplash.com/photo-1560790671-b76ca4de55ef?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=434&q=80",
      });
              ...
              <form className='form' onSubmit={handleSubmit(handleSignUp)}>
                ...
                <Field>
                  ...
                  <Input 
                    name="email" 
                    type="email" 
                    placeholder="Enter your email" control={control}/>   
                </Field>
                <Field>
